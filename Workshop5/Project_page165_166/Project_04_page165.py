...
Problem:
    4.  Make the following modifications to the original sentence-generator program:
        ...
        b.  A conjunction and a second independent clause are optional: The boy took a drink and the girl
            played baseball.
